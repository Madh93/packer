...
- `env` - Returns environment variables. See example in [using home
  variable](/docs/legacy_json_templates/user-variables#using-home-variable)
...
- `isotime [FORMAT]` - UTC time, which can be
  ...
  reference](/docs/legacy_json_templates/egine#isotime-function-format-reference).
...
user variables. See the [user variable](/docs/legacy_json_templates/user-variables)
