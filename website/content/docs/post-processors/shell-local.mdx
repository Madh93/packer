...
- `execute_command` (array of strings) - The command used to execute the
  ...
  This is treated as a [template engine](/docs/legacy_json_templates/egine).
  ...
  generated data using the [build](/docs/legacy_json_templates/egine) template
...
- `PACKER_BUILD_NAME` is set to the [name of the
  build](/docs/legacy_json_templates/builders#named-builds) that Packer is running.
