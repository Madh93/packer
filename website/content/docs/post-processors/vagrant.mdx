...
[using post-processors](/docs/legacy_json_templates/post-processors) in templates.
...
- `output` (string) - The full path to the box file that will be created by
  ...
  [template engine](/docs/legacy_json_templates/egine). Therefore, you may use user
...
- `vagrantfile_template` (string) - Path to a template to use for the
  Vagrantfile that is packaged with the box. This option supports the usage of the [template engine](/docs/legacy_json_templates/egine)
...
artifacts](/docs/legacy_json_templates/post-processors#input-artifacts) for more information.
