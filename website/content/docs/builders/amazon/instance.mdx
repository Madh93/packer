...
This builder generates data that are shared with provisioner and post-processor via build function of [template engine](/docs/legacy_json_templates/egine) for JSON and [contextual variables](/docs/templates/hcl_templates/contextual-variables) for HCL2.
...
templates](/docs/legacy_json_templates/egine) and have support for their own set of
template variables.
