...
[communicator](/docs/legacy_json_templates/communicators) can be configured for this builder.
...
- `snapshot_name` (string) - The name of the resulting snapshot that will
  ...
  [configuration templates](/docs/legacy_json_templates/egine) for more info).
