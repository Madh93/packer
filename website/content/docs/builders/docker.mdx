...
standard [communicators](/docs/legacy_json_templates/communicators).
...
This build shares generated data with provisioners and post-processors via [template engines](/docs/legacy_json_templates/egine)
...
[Post-Processors](/docs/legacy_json_templates/post-processors) for more information):
...
pipeline, see [Post-Processors](/docs/legacy_json_templates/post-processors) for more
information):
