...
In addition to the options listed here, a [communicator](/docs/legacy_json_templates/communicators)
...
[template engine](/docs/legacy_json_templates/egine) for JSON and [contextual variables](/docs/templates/hcl_templates/contextual-variables)
for HCL2.
