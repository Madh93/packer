...
- `chef_license` (string) - As of Chef v15, Chef requires users to accept a
  ...
  This is a [template engine](/docs/legacy_json_templates/egine.html). Therefore, you
...
- `execute_command` (string) - The command used to execute Chef. This has
  various [configuration template variables](/docs/legacy_json_templates/egine)
...
- `knife_command` (string) - The command used to run Knife during node
  ...
  variables](/docs/legacy_json_templates/egine) available. See below for more
  information.
...
This template is a [configuration template](/docs/legacy_json_templates/egine) and
...
[var file](/docs/legacy_json_templates/user-variables).
