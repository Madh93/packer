...
type Config struct {
	...
	// engine](/docs/legacy_json_templates/egine), and you may access any of the variables
	// stored in the generated data using the [build](/docs/legacy_json_templates/egine)
	// template function.
